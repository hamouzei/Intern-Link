    ...
    return (
        <main className="min-h-screen bg-[#0d0d0d] text-white">
            ...
            <nav className="flex items-center justify-between px-8 py-5 border-b border-white/10">
                <span className="text-xl font-bold tracking-tight text-[#f5c842]">InternLink</span>
            ...
            <section className="flex flex-col items-center text-center px-6 pt-28 pb-20">
                <div className="mb-5 inline-block px-4 py-1.5 rounded-full bg-[#f5c842]/10 border border-[#f5c842]/30 text-[#f5c842] text-sm font-medium">
                    AI-Powered Internship Applications
                </div>
                <h1 className="text-6xl md:text-8xl font-extrabold leading-none mb-6 bg-gradient-to-br from-white via-gray-200 to-gray-500 bg-clip-text text-transparent max-w-4xl">
                    Apply Smarter.<br />
                    <span className="text-[#f5c842]">Land Faster.</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <button
                        onClick={() => signIn.social({ provider: "google" })}
                        className="flex items-center gap-3 px-8 py-4 bg-white text-gray-900 font-semibold rounded-xl hover:bg-gray-100 transition shadow-lg text-base"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center gap-3 px-8 py-4 bg-[#1a1a1a] text-white font-semibold rounded-xl border border-white/10 hover:bg-[#222] transition shadow-lg text-base"
                    >
            ...
            <section className="max-w-5xl mx-auto px-6 pb-32 grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                    ...
                    <div key={f.title} className="p-7 rounded-2xl bg-white/5 border border-white/10 hover:border-[#f5c842]/30 transition-colors duration-300">
